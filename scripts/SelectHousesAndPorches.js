...
function SelectHousesAndPorches(isHouseKeeper, modalWindowParams, localStorageParams, ShowModalFunction)
{
    ...
    if(!localStorageParams.HouseId){
        throw new Error("Missing \"HouseId\" field in function localStorageParams object")
    }
    else if(!localStorageParams.HouseName){
        throw new Error("Missing \"HouseName\" field in function localStorageParams object")
    }
    else if(!localStorageParams.PorchId){
        throw new Error("Missing \"PorchId\" field in function localStorageParams object")
    }
    else if(!localStorageParams.PorchName){
        throw new Error("Missing \"PorchId\" field in function localStorageParams object")
    }
...
function SelectHouses(isHouseKeeper,modalWindowParams, localStorageParams, ShowModalFunction)
{
    ...
    //добавляем надпись
    document.getElementById(modalWindowParams.modalHeaderTitleId).innerHTML = "Оберіть необхідний будинок:";
